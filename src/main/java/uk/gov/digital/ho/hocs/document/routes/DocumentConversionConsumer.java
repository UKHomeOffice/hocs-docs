    ...
    public void configure() {
        ...
        from("direct:convertdocument").routeId("conversion-queue")
                ...
                .otherwise()
                    ...
                    .log(LoggingLevel.DEBUG, "Conversion - Retrieved document from trusted S3 ${body.originalFilename}")
        ...
        from("direct:convert").routeId("conversion-convert-queue")
                ...
                .log(LoggingLevel.DEBUG, "Calling document converter service")
                .to(hocsConverterPath)
                .choice()
                .when(HttpProcessors.validateHttpResponse)
                    .log(LoggingLevel.DEBUG, "Document conversion successful")
