...
- name: CLAMAV_ROOT
  value: '{{ tpl .Values.app.clamAvRoot . }}'
- name: HOCSCONVERTER_ROOT
  value: '{{ tpl .Values.app.conveterRoot . }}'
- name: DB_HOST
  valueFrom:
    secretKeyRef:
...
- name: DOCS_QUEUE_NAME
  value: '{{ tpl .Values.app.docsQueueName . }}'
- name: DOCS_QUEUE_DLQ_NAME
  value: '{{ tpl .Values.app.docsQueueNameDlq . }}'
...
- name: AUDIT_TOPIC_NAME
  value: '{{ tpl .Values.app.auditTopicName . }}'
